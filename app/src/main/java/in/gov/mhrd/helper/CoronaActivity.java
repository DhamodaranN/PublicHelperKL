...
public class CoronaActivity extends AppCompatActivity implements MainInfoContentCardsAdapter.CardClicked{

    private String TAG = CoronaActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layoutManager=new GridLayoutManager(CoronaActivity.this,2,GridLayoutManager.VERTICAL,false);
        recyclerView.setLayoutManager(layoutManager);
        marker = new MyGraphMarker(CoronaActivity.this,R.layout.marker_view);
        RefreshFunc();
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item)
    {
        switch (item.getItemId())
        {
            case R.id.refresh:
                ...
                break;
            case R.id.about:
                Toast.makeText(CoronaActivity.this,"Developed by GOV",Toast.LENGTH_SHORT).show();
                break;
        }
    ...
    {
        Intent intent=new Intent(CoronaActivity.this,in.gov.mhrd.helper.StateDataActivity.class);
    ...
    {
        Intent intent1=new Intent(CoronaActivity.this,in.gov.mhrd.helper.StateDataActivity.class);
    ...
    private class RetrieveCovidData extends AsyncTask<Void, Void,ArrayList<MainInfoContentCards>>
    {
        ...
        protected ArrayList<MainInfoContentCards> doInBackground(Void... arg0)
        {
            ...
            if (jsonStr != null)
            {
                ...
                } catch (final JSONException e)
                {
                    ...
                    Toast.makeText(CoronaActivity.this,"Json parsing error!",Toast.LENGTH_LONG).show();
        ...
        protected void onPostExecute(ArrayList<MainInfoContentCards> result) {
            ...
            if(result.isEmpty())
            {
                ...
                AlertDialog.Builder alert=new AlertDialog.Builder(CoronaActivity.this);
            ...
            {
                myAdapter=new MainInfoContentCardsAdapter(CoronaActivity.this,result);
